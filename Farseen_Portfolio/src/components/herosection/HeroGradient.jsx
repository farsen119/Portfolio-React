...
const HeroGradient = () => {
  return (
    <div>
      ...
      <div className='shadow-cyanMediumshadow absolute top-[300px] left-0 -z-10 opacity-50 '>
      </div>
      <div className='shadow-orangeMediumShadow absolute top-[500px] left-0 -z-10 opacity-50 '>
      </div>
    </div>
  )
}
